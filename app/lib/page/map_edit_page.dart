...
class _MapEditPageState extends State<MapEditPage> {
              ...
              children: [
                ...
                onObstacleEditEnd: (oldEdits, newEdits) {
                  ...
                  onRouteTap: (route) {
                    ...
                    _showRouteDialog(context, theme, wsChannel);
                  },
                  onNavPointTap: (p) {
                    setState(() {
                      selectedNavPoint = p;
                    ...
                    if (selectedTool == EditToolType.AddRoute) {
                      _handleAddRouteTap(wsChannel, p);
                    }
                  },
                ...
                if (selectedNavPoint != null && selectedTool != EditToolType.AddRoute)
                  _buildNavPointPanel(context, theme, wsChannel),
              ],
            ),
          ),
        ),
  ...
  void _handleAddRouteTap(WsChannel wsChannel, NavPoint? p) {
    if (p == null) {
      setState(() {
        _routeStartPointName = null;
      });
  ...
  void _showRouteDialog(BuildContext context, ThemeData theme, WsChannel wsChannel) {
  ...
  Widget _buildNavPointPanel(BuildContext context, ThemeData theme, WsChannel wsChannel) {
    final mapManager = wsChannel.mapManager;
